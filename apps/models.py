...
class Address(models.Model):
    ...
    def __str__(self):
        return f" City({self.city}), Address({self.address}), Postal code({self.postal_code}) "
...
class AuthPermission(models.Model):
    ...
    def __str__(self):
        return f"Name( {self.name}), Content type( {self.content_type}), Code name( {self.codename})"
...
class AuthUser(models.Model):
    ...
    def __str__(self):
        return f"User name( {self.username}), First name( {self.first_name}), Last name( {self.last_name}), Is super user({self.is_superuser}), " \
               f"Is staff({self.is_staff}), Is active({self.is_active})"
...
class City(models.Model):
    ...
    def __str__(self):
        return f"{self.country}, City( {self.city})"
...
class Customer(models.Model):
    ...
    def __str__(self):
        return f"First name( {self.first_name}), Last name( {self.last_name}), Address( {self.address})"
...
class DjangoContentType(models.Model):
    ...
    def __str__(self):
        return f"{self.model}, {self.app_label}"
...
class DjangoMigrations(models.Model):
    ...
    def __str__(self):
        return f"{self.name}, {self.applied}, {self.app}"
...
class DjangoSession(models.Model):
    ...
    def __str__(self):
        return f"{self.session_data}, {self.expire_date} {self.session_key}"
...
class Film(models.Model):
    ...
    def __str__(self):
        return f" Film( {self.title}), Language( {self.language}), Release year( {self.release_year})"
...
class Payment(models.Model):
    ...
    def __str__(self):
        return f"{self.amount} customer({self.customer}), staff({self.staff}) "
...
class Rental(models.Model):
    ...
    def __str__(self):
        return f"{self.rental_date} {self.return_date} {self.staff}"
...
class Store(models.Model):
    ...
    def __str__(self):
        return f"{self.address}, {self.manager_staff}"
